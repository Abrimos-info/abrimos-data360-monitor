   ...
   6: 
   7: # Number of maritime partner economies
   8: 
   9: > CT_MC
  10: 
  11: ## Identification
  ...
  25: ## Links
  26: 
  27: - **csv**: https://data360files.worldbank.org/data360-data/data/WB_LPI_20/CT_MC.csv
  28: - **json metadata**: https://data360files.worldbank.org/data360-data/metadata/WB_LPI_20/CT_MC.json
  29: - **api template**: https://data360api.worldbank.org/data360/data?top=1000&skip=0&DATABASE_ID=WB_LPI_20&INDICATOR=CT_MC
  30: - **dataset on Data360**: https://data360.worldbank.org/en/search?query=WB_LPI_20
  31: 
  32: ## Definition
  33: 
  34: Number of economies accessible through direct liner shipping services
  35: 
  36: ## Methodology
  37: 
  38: The indicator is calculated using the shipping schedules in the MDS Transmodal Containership Databank indicating the ports and economies serviced by every liner shipping service by year and quarter. For a given economy, the number of unique economy partners is aggregated by year.
  39: 
  40: ## Sources
  41: 
  42: 
 ...
 115: 
 116: - candidate_id: cand_anomaly_MEX_CT_MC_2024
 117:   type: anomaly
 118:   country: MEX
 119:   observation: { period: 2024, value: 52, unit: PRTN }
 120:   previous: { period: 2023, value: 53 }
 121:   REDACTAR CON ESTOS VALORES: valor actual (2024): 52; anterior (2023): 53; Δ=-1, -1.9% (baja)
 122:   z_score: 3.26
 123:   regional_median: 23
 124:   claim_id: 1d6a5b4828c32096
 125: 
