  ...
  25: ## Links
  26: 
  27: - **csv**: https://data360files.worldbank.org/data360-data/data/WB_LPI_20/CT_ALLI.csv
  28: - **json metadata**: https://data360files.worldbank.org/data360-data/metadata/WB_LPI_20/CT_ALLI.json
  29: - **api template**: https://data360api.worldbank.org/data360/data?top=1000&skip=0&DATABASE_ID=WB_LPI_20&INDICATOR=CT_ALLI
  30: - **dataset on Data360**: https://data360.worldbank.org/en/search?query=WB_LPI_20
  31: 
  32: ## Definition
  33: 
  34: Number of direct container liner shipping alliances servicing the ports in an economy. A shipping alliance (or maritime alliance) is an agreement between two or more shipping lines to manage operational and commercial activities. This can include vessel sharing to expand network coverage.
  35: 
  36: ## Methodology
  37: 
  38: The indicator is calculated using the shipping schedules in the MDS Transmodal Containership Databank indicating the number of liner shipping service alliances in an economy by year and quarter. For a given economy, the indicator is the average number of alliances operating in the economy across four quarters of each year.
  39: 
  40: ## Sources
  41: 
  42: 
 ...
 115: 
 116: - candidate_id: cand_anomaly_MEX_CT_ALLI_2024
 117:   type: anomaly
 118:   country: MEX
 119:   observation: { period: 2024, value: 3, unit: ALLIANC }
 120:   previous: { period: 2023, value: 3 }
 121:   REDACTAR CON ESTOS VALORES: valor actual (2024): 3; anterior (2023): 3; Δ=+0, +0.0% (sin cambio)
 122:   z_score: 2023472278.43
 123:   regional_median: 0
 124:   claim_id: 46b069d0e358e737
 125: 
