   ...
   6: 
   7: # Press Freedom Index: Economic context
   8: 
   9: > RWB_PFI_ECC
  10: 
  11: ## Identification
  ...
  25: ## Links
  26: 
  27: - **csv**: https://data360files.worldbank.org/data360-data/data/RWB_PFI/RWB_PFI_ECC.csv
  28: - **json metadata**: https://data360files.worldbank.org/data360-data/metadata/RWB_PFI/RWB_PFI_ECC.json
  29: - **api template**: https://data360api.worldbank.org/data360/data?top=1000&skip=0&DATABASE_ID=RWB_PFI&INDICATOR=RWB_PFI_ECC
  30: - **dataset on Data360**: https://data360.worldbank.org/en/search?query=RWB_PFI
  31: 
  32: ## Definition
  33: 
  34: This indicator aims to evaluate:
  35: - economic constraints linked to governmental policies (including the difficulty of creating a news media outlet, favouritism in the allocation of state subsidies, and corruption);
  36: - economic constraints linked to non-state actors (advertisers and commercial partners);
  37: - economic constraints linked to media owners seeking to promote or defend their business interests.
  38: 
  ...
  93: |-----------|--------|-------|------|
  94: | GOV_WGI_CC | 2024 | -0.77568 | U |
  95: | GOV_WGI_GE | 2024 | -0.219613 | U |
  96: | WB_CCDFS_GGDY | 2022 | 57.686 | PT |
  97: | WB_WDI_BN_CAB_XOKA_GD_ZS | 2024 | 5.650429 | PT_GDP |
  98: | WB_WDI_BX_KLT_DINV_WD_GD_ZS | 2024 | 0.355365 | PT_GDP |
  99: | WB_WDI_FP_CPI_TOTL_ZG | 2024 | 1.547325 | PC_A |
 100: | WB_WDI_GC_XPN_INTP_RV_ZS | 2022 | 4.662799 | PT_REV |
 101: | WB_WDI_NY_GDP_MKTP_KD_ZG | 2024 | -2.001255 | PC_A |
 102: | WB_WDI_NY_GDP_PCAP_CD | 2024 | 6874.70574 | USD |
 103: | WB_WDI_SE_SEC_ENRR | 2023 | 92.811803 | PT |
 104: | WB_WDI_SH_DYN_MORT | 2024 | 12.9 | DT_10P3BR_L |
 105: | WB_WDI_SH_STA_MMRT | 2023 | 55 | DT_10P5BR_L |
 106: 
 107: 
 ...
 116: Protagonista (mayor |z|): ECU. Usá sus números en lead, observation y titular.
 117: 
 118: - candidate_id: cand_anomaly_ECU_RWB_PFI_ECC_2025
 119:   type: anomaly
 120:   country: ECU
 121:   observation: { period: 2025, value: 77, unit: RANK }
 ...
 123:   REDACTAR CON ESTOS VALORES: valor actual (2025): 77 — sin período anterior en la detección
 124:   z_score: -2.33
 125:   regional_median: 122
 126:   claim_id: 0b4a9a724c4c63f0
 127: 
 128: ### allowed_claim_ids
 129: Estos son los ÚNICOS valores válidos para `CLAIM_ID` dentro de `{{claim:CLAIM_ID|valor}}`. Cualquier otro será rechazado por la validación automática.
 130: 
 131: - 0b4a9a724c4c63f0
 132: 
 133: 