...
- **csv**: https://data360files.worldbank.org/data360-data/data/WB_KNOMAD/WB_KNOMAD_MRO.csv
- **json metadata**: https://data360files.worldbank.org/data360-data/metadata/WB_KNOMAD/WB_KNOMAD_MRO.json
- **api template**: https://data360api.worldbank.org/data360/data?top=1000&skip=0&DATABASE_ID=WB_KNOMAD&INDICATOR=WB_KNOMAD_MRO
- **dataset on Data360**: https://data360.worldbank.org/en/search?query=WB_KNOMAD

## Definition

Remittance outward flows (US$ million)
