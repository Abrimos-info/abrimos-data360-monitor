# Bilateral Estimate of Migrant Stocks
...
- **database**: The Global Knowledge Partnership on Migration and Development (KNOMAD) database
- **periodicity**: Annual
- **unit**: US dollars
- **confidentiality**: PU
...
- **csv**: https://data360files.worldbank.org/data360-data/data/WB_KNOMAD/WB_KNOMAD_MIG.csv
- **json metadata**: https://data360files.worldbank.org/data360-data/metadata/WB_KNOMAD/WB_KNOMAD_MIG.json
- **api template**: https://data360api.worldbank.org/data360/data?top=1000&skip=0&DATABASE_ID=WB_KNOMAD&INDICATOR=WB_KNOMAD_MIG
- **dataset on Data360**: https://data360.worldbank.org/en/search?query=WB_KNOMAD

## Definition

Estimate of Migrant Stocks
...
- Finance _(Data360 Topic L1)_
- Financial Inclusion, Infrastructure and Access _(Data360 Topic L2)_
