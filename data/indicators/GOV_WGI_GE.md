...
- **csv**: https://data360files.worldbank.org/data360-data/data/WB_WGI/GOV_WGI_GE.csv
- **json metadata**: https://data360files.worldbank.org/data360-data/metadata/WB_WGI/GOV_WGI_GE.json
- **api template**: https://data360api.worldbank.org/data360/data?top=1000&skip=0&DATABASE_ID=WB_WGI&INDICATOR=GOV_WGI_GE
- **dataset on Data360**: https://data360.worldbank.org/en/int/dataset/WB_WGI

## Definition

Government Effectiveness (GE) captures perceptions of the quality of public services, the civil service, policy formulation and implementation, and the credibility of a government’s decisions.
