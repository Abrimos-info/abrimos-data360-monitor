...
- **csv**: https://data360files.worldbank.org/data360-data/data/WB_LPI_20/TRS_T.csv
- **json metadata**: https://data360files.worldbank.org/data360-data/metadata/WB_LPI_20/TRS_T.json
- **api template**: https://data360api.worldbank.org/data360/data?top=1000&skip=0&DATABASE_ID=WB_LPI_20&INDICATOR=TRS_T
- **dataset on Data360**: https://data360.worldbank.org/en/search?query=WB_LPI_20

## Definition

Average time inbound containers in an economy spend in transshipment at intermediate port facilities during the shipping phase of its journey. Transshipment refers to moving a container from one ship to another before reaching the final destination.
...
The transshipment time of a container traveling from origin port to destination port is calculated for all inbound shipments as the averaged value of total (aggregated) time that a container spends transshipping at intermediate port facilities during the maritime shipping phase of its voyage.
