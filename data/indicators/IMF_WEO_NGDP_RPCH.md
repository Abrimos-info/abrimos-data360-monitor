...
- **csv**: https://data360files.worldbank.org/data360-data/data/IMF_WEO/IMF_WEO_NGDP_RPCH.csv
- **json metadata**: https://data360files.worldbank.org/data360-data/metadata/IMF_WEO/IMF_WEO_NGDP_RPCH.json
- **api template**: https://data360api.worldbank.org/data360/data?top=1000&skip=0&DATABASE_ID=IMF_WEO&INDICATOR=IMF_WEO_NGDP_RPCH
