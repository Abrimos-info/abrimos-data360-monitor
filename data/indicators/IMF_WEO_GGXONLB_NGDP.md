...
- **csv**: https://data360files.worldbank.org/data360-data/data/IMF_WEO/IMF_WEO_GGXONLB_NGDP.csv
- **json metadata**: https://data360files.worldbank.org/data360-data/metadata/IMF_WEO/IMF_WEO_GGXONLB_NGDP.json
- **api template**: https://data360api.worldbank.org/data360/data?top=1000&skip=0&DATABASE_ID=IMF_WEO&INDICATOR=IMF_WEO_GGXONLB_NGDP
