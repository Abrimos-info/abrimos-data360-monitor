...
A prototype by **[Abrimos.info](https://abrimos.info)** for the **Data360 Global Challenge** (World Bank + Media Party), phase 2.

## Status

Ten-day sprint (21–31 May 2026). Submission deadline: **31 May 2026** via Media Party Hub.

## Stack

- **Frontend**: Node.js + React (dashboard)
- **Backend**: Node.js, OpenSearch
- **Data layer**: Data360 API v3 client (direct REST)
- **LLM**: Claude Opus 4.7 via Agent SDK
- **Verification**: [Proof-Carrying Numbers (PCN)](https://github.com/worldbank/pcn) — World Bank
...
Roadmap: narrative-vs-data divergences, invisible trends, untold milestones.

## Challenge deliverables

1. Working prototype + repo (this repository)
2. Demo video (5 min)
...
5. Security & data handling — [`docs/security-data-handling.md`](docs/security-data-handling.md)
