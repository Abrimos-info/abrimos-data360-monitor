...
function buildCandidate(detection, sequence) {
  ...
  const claimId = computeClaimId(claimInputFromObservation(observation, {
  ...
  return {
    ...
    alert: {
      ...
      observation: {
        ...
        comp_breakdown_1: observation.comp_breakdown_1,
        comp_breakdown_2: observation.comp_breakdown_2,
        comp_breakdown_3: observation.comp_breakdown_3,
        sex: observation.sex,
        age: observation.age,
        urbanisation: observation.urbanisation,
      },
      ...
      verification_trace: {
        data360_dataset_url: datasetSearchUrl(databaseId),
        csv_link: csvUrl(databaseId, idno),
